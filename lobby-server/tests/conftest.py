...
# WARNING: Ensure imports from `lobby_server` comes after this line
from lobby_server import app, settings, db  # noqa
from lobby_server.cli import create_user, cli  # noqa
